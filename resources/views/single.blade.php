        ...
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{ route('category.single', ['id'=> $post->category]) }}">{{$post->category->name}},</a>
                        ...
                        <div class="post__content-info">
                          ...
                          {!! $post->content !!}<!-- the double exclammation used to output the html content in the databse since the database recieves the content as html -->
                ...
                @if($previous)
                    ...
                    <a href="{{ route('post.single', ['id' => $previous->id] )}}" class="btn-next-wrap">
               ...
               <a href="{{ route('post.single', ['id' => $next->id] )}}" class="btn-prev-wrap">
                <svg class="btn-prev">
